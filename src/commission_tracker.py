"""Commission-Tracker fuer Expedia [CRUX-MK].

Trackt 20%-Kommission pro Booking + Aggregat-Reports.
...
class CommissionTracker:
    ...
    COMMISSION_PCT_DEFAULT = 0.20

    def __init__(self, df_id: str = "df-ota-expedia-adapter", storage_dir: str = "audit"):
        self.df_id = df_id
    ...
    def record_booking(self, booking: dict) -> CommissionRecord:
        ...
        try:
            ...
            record = CommissionRecord(
                ...
                vendor=booking.get("vendor", "expedia"),
            )
