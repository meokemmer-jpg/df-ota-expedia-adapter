"""Expedia-Adapter-Orchestrator [CRUX-MK].

LaunchAgent-Entry-Point fuer Welle-37 HeyLou-Mosaic-Adapter Expedia.
...
class ExpediaAdapterOrchestrator:
    """Orchestriert Expedia-Adapter-LaunchAgent-Run."""

    DF_ID = "df-ota-expedia-adapter"

    def __init__(self, tenant_id: Optional[str] = None):
        self.tenant_id = tenant_id or os.environ.get("DF_OTA_EXPEDIA_TENANT_ID", "hildesheim")
        ...
        self.auth = ExpediaAuthManager(sandbox_mode=self.sandbox_mode)
        self.connector = ExpediaConnector(sandbox_mode=self.sandbox_mode)
...
def main():
    ...
    orch = ExpediaAdapterOrchestrator()
    report = orch.run()
