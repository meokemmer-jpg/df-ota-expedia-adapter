"""W41-A Idempotency-Integration-Tests fuer expedia-ota [CRUX-MK]."""
...
from src.expedia_adapter import ExpediaConnector  # noqa: E402
...
@pytest.fixture
def adapter():
    a = ExpediaConnector(sandbox_mode=True)
